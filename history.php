...
if(isset($_POST['score'])){
  ...
  $history_record = $sr_db->prepare("Insert into History (user_id, passage_id, timed_reading_wpm, timed_reading_time, scrolled_reading, comprehension_quiz, date_modified) values (?,?,?,?,?,?, now())");
